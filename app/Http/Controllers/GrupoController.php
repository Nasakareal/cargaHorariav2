...
class GrupoController extends Controller
{
    ...
    {
        $this->middleware('auth'); // protege todo el controlador
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $id = DB::table('groups')->insertGetId([
                ...
                'area'              => $program->area ?? null,   // sincrónico con el programa
    ...
    public function show($id)
    {
        ...
        // Materias del grupo + profesor (si existe)
    ...
    {
        $grupo = DB::table('groups')->where('group_id', $id)->first();
        if (!$grupo) {
        ...
        return view('grupos.edit', compact('grupo','programas','terminos','turnos'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::table('groups')->where('group_id', (int)$id)->update([
                'group_name'        => $request->group_name,
                'program_id'        => $request->program_id,
                'area'              => $program->area ?? null, // mantener en sync
                'term_id'           => $request->term_id,
                'volume'            => $request->volume ?? 0,
                'turn_id'           => $request->turn_id,
                'classroom_assigned'=> $request->classroom_assigned,
    ...
    public function destroy($id)
    {
        ...
        // Bloquear borrado si tiene materias o asignaciones
