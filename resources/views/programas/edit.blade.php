...
@section('content_header')
  <h1 class="text-center w-100">Edición de programa</h1>
@endsection
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card card-outline card-success">
        ...
        <div class="card-body">
          <form id="editForm" action="{{ route('programas.update', $programa->program_id) }}" method="POST" autocomplete="off">
            @csrf
            @method('PUT')
