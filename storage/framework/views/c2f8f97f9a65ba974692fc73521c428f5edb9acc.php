    ...
    <div class="public-section">
      <div class="container">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="text-center small">
              <strong>Total de grupos con faltantes:</strong> <?php echo e($total_grupos_faltantes); ?>

              &nbsp;|&nbsp;
              <strong>Total de materias faltantes:</strong> <?php echo e($total_materias_faltantes); ?>

            </p>

            <?php if(($grupos_con_faltantes ?? collect())->count()): ?>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form method="GET" action="<?php echo e(route('welcome')); ?>" class="form-inline" style="margin-bottom:12px">
              ...
              <select id="groupSelector" name="group_id" class="select" onchange="this.form.submit()">
                ...
                <?php $__currentLoopData = $grupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($g->group_id); ?>" <?php echo e((int)$group_id === (int)$g->group_id ? 'selected' : ''); ?>>
            ...
            <?php if($grupoSel): ?>
              <p class="small" style="margin-bottom:10px">
                <strong>Grupo:</strong> <?php echo e($grupoSel->group_name); ?>

                <?php if(!empty($grupoSel->turn_name)): ?> &nbsp;|&nbsp; <strong>Turno:</strong> <?php echo e($grupoSel->turn_name); ?> <?php endif; ?>
              </p>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover table-sm">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $horas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        <td><?php echo e($hLabel); ?></td>
                        <?php $__currentLoopData = $dias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php
                            $contenido = $tabla[$hLabel][$dia] ?? '';
                            $sinProfe  = stripos($contenido, 'sin profesor') !== false ? 'sin-profe' : '';
                          ?>
                          <td class="<?php echo e($sinProfe); ?>"><?php echo $contenido ?: '&nbsp;'; ?></td>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </tbody>
